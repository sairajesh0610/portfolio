...
const AboutSection = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-6 py-6 md:grid-cols-1 lg:gap-8">
        {/* Bio */}
        <div className="">
          <p className="text-justify">
            Hi, I am Sai Rajesh Gudimetla, with 7 years of experience in full-stack development, specializing in
            building highly scalable, high-performance web and mobile applications using React, React Native, and Java
            Spring Boot. Proficient in TypeScript, JavaScript (ES6+), and cloud platforms, focusing on performance
            optimization, code reusability, and security. Adept at mentoring teams, fostering growth, and delivering
            user-centric applications while implementing best practices for development and deployment.
          </p>
