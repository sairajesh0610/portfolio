  ...
  return (
    <div className="py-4">
      ...
      <div className="mt-3 flex items-center">
        <button className="flex items-center text-gray-500 hover:text-indigo-500 dark:text-gray-400 dark:hover:text-indigo-500">
          <FiHeart className="h-4" />
          <span className="ml-1 text-sm">{comment.totalLikes} likes</span>
        </button>

        <button className="ml-4 flex items-center text-gray-500 hover:text-indigo-500 dark:text-gray-400 dark:hover:text-indigo-500">
