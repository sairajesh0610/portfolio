      ...
      <div className="container">
        <div className="mt-24 flex flex-col items-center justify-center">
          ...
          <p className="mt-4 flex items-center text-gray-400">
            ...
            <span className="mx-2 h-1.5 w-1.5 rounded-full bg-indigo-500"></span>
        ...
        <div className="my-10 rounded-lg bg-gray-50 py-3 shadow-md dark:bg-gray-800">
        ...
        <div className="mb-10 flex h-48 flex-col items-center justify-center">
          ...
          <Link href="/contact">
            <a className="mt-5 rounded-full bg-indigo-500 px-8 py-2 font-semibold tracking-wide text-white hover:bg-indigo-600 focus:ring-2 focus:ring-primary-200">
              Start a project
            </a>
          </Link>
        </div>
